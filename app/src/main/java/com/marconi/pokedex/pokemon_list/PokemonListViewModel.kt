package com.marconi.pokedex.pokemon_list
...
import com.marconi.pokedex.data.models.PokedexListEntry
import com.marconi.pokedex.repository.PokemonRepository
import com.marconi.pokedex.util.Constants.PAGE_SIZE
    ...
    fun calcDominantColor(drawable: Drawable, onFinish: (Color) -> Unit) {
        ...
        Palette.from(bmp).generate { palette ->
            palette?.dominantSwatch?.rgb?.let { colorValue ->
                Log.d("TAG", "calcDominantColor: $colorValue")
